...
public class MySortedLL {
    ...
    //add data x to the sorted linked list --> O(n/2)
    public LL_Element add(Comparable x){
        ...
        else if (after==head){//add x to the beginning
            newEle.next= head;
